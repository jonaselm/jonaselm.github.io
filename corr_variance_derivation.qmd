...
First, deriving the expected value for W $\sim S_{\alpha/2}((\pi \alpha/4)^{(2/\alpha)},1, 0;1)$, a maximally skewed scalar random variable with support on the positive real numbers. We can use the fact that we can decompose a sg-S$\alpha$S(1) random variable into the product of the square root of W and normal random variable $G \sim N(0,\sigma^2)$ independent of W:
...
&= \frac{2\Gamma(-2p/\alpha)}{\alpha\Gamma(-p)}\bigg(\frac{2^p \sigma_1^p \sigma_2^p}{\pi}\bigg)2\Gamma(\frac{p+1}{2}){}_2F_1(-\frac p 2, -\frac p 2, \frac 1 2, \rho^2)- C^2(p,\alpha)\gamma_1^{p/\alpha}\gamma_2^{p/\alpha}\\
&= \frac{2\Gamma(-2p/\alpha)}{\alpha\Gamma(-p)}\bigg(\frac{2^{2p} \gamma_1^{p/\alpha} \gamma_2^{p/\alpha}}{\pi}\bigg)2\Gamma(\frac{p+1}{2}){}_2F_1(-\frac p 2, -\frac p 2, \frac 1 2, \rho^2)- C^2(p,\alpha)\gamma_1^{p/\alpha}\gamma_2^{p/\alpha}
\end{aligned}
$$
...
\rho_{3,2} \equiv \frac{\rho \sigma_1\sigma_2 - \sigma_2^2 }{\sigma_1 \sqrt{\sigma_1^2 + \sigma_2^2 - 2\rho \sigma_1 \sigma_2}}
\end{aligned}
$$
