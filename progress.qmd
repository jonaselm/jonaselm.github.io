...
This also leads to a potential alternative idea of optimality vs. the minimum variance p: instead, we may want to choose p that minimizes the absolute forecast error. 
