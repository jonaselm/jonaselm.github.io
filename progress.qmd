...
## The Subordinated Covariance Estimator
...
From here, the subordinated covariance estimator I define as $\hat s$ below is an asymptotically unbiased estimator of the covariance of any components of the subordinated Gaussian vector [(see proof)](sce_derivation.qmd):
...
This also leads to a potential alternative idea of optimality vs. the minimum variance p: instead, we may want to choose p that minimizes the forecast error. 

Looking at the impact of the choice of p on the variance of the estimator:
