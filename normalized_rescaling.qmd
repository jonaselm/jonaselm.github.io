...
Here, $\bar{\sigma}^2$ is the average variance of the components of $G$. In a more Random Matrix Theory context, it's also the normalized trace of $\Sigma$: $\tau(\Sigma)$, using the notation of Potters & Bouchaud. By the assumptions on the eigenvalues of $\Sigma$, for any choice of $d$, this is a constant with $m \leq \bar{\sigma}^2 \leq M$. Taking square roots and applying the continuous mapping theorem, we get $\frac{1}{d}\|\Lambda^{1/2}Z\|^2 \underset{d \rightarrow \infty}{\overset{\text{a.s.}}{\longrightarrow}} \bar{\sigma}^2 \implies \frac{\|\Lambda^{1/2}Z\|}{\sqrt d \bar{\sigma}}\underset{d \rightarrow \infty}{\overset{\text{a.s.}}{\longrightarrow}} 1$. 
